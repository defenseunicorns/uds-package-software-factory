...
func SetupTestPlatform(t *testing.T, platform *types.TestPlatform) { //nolint:funlen
	...
	teststructure.RunTestStage(t, "SETUP", func() {
		...
		output, err = platform.RunSSHCommandAsSudo(`cd ~/app && uds bundle deploy oci://ghcr.io/defenseunicorns/uds-package/software-factory-demo:%s --confirm`, latestversion)
		require.NoError(t, err, output)
